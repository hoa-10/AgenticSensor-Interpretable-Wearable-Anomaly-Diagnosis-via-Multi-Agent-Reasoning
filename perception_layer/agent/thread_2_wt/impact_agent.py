...
class Thread2ImpactAgent:
    ...
    def run(
        ...
        print_phase("THREAD 2 IMPACT ANALYSIS OUTPUT", json_for_log(impact_analysis))
        ...
        print_phase("THREAD 2 IMPACT AGENT INPUT", prompt)
        ...
        print_phase("THREAD 2 IMPACT AGENT OUTPUT", agent_output)
        return {
            "impact_analysis": impact_analysis,
