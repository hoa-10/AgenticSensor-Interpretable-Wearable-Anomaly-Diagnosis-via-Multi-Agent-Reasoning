...
class Thread2HealthAgent:
    ...
    def run(
        ...
        print_phase("THREAD 2 HEALTH ANALYSIS OUTPUT", json_for_log(health_analysis))
        ...
        print_phase("THREAD 2 HEALTH AGENT INPUT", prompt)
        ...
        print_phase("THREAD 2 HEALTH AGENT OUTPUT", agent_output)
        return {
            "health_analysis": health_analysis,
