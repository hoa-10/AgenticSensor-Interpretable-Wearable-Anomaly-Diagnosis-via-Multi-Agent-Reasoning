...
class Thread2SensorFaultAgent:
    ...
    def run(
        ...
        print_phase("THREAD 2 SENSOR FAULT ANALYSIS OUTPUT", json_for_prompt(fault_analysis))
        ...
        print_phase("THREAD 2 SENSOR FAULT AGENT INPUT", prompt)
        ...
        print_phase("THREAD 2 SENSOR FAULT AGENT OUTPUT", agent_output)
        return {
            "fault_analysis": fault_analysis,
